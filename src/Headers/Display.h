...
struct ClothRender // Texture & Lighting
{
    ...
    ClothRender(Cloth* cloth)
    {
        ...
        Program program("../../resources/Shaders/ClothVS.glsl", "../../resources/Shaders/ClothFS.glsl");
...
struct SpringRender
{
    ...
    void init(std::vector<Spring*> s, glm::vec4 c, glm::vec3 modelVec)
    {
        ...
        /** Build render program **/
        Program program("../../resources/Shaders/SpringVS.glsl", "../../resources/Shaders/SpringFS.glsl");
        programID = program.ID;
